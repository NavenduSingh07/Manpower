...
<body class="body">
    ...
    <main class="container">
        ...
        <form id="multiStepForm" action="formOutputsubmit.php" method="post">
            <!-- Step 1 -->
            <div class="step active">
                <?php
                generateDropdown($conn, $departmentName, 'Supervisor', '');
                generateDropdown($conn, $departmentName, 'Operator', 'Trimming');
                generateDropdown($conn, $departmentName, 'Labour', 'Trimming');
                generateDropdown($conn, $departmentName, 'Operator', 'Visual');
                generateDropdown($conn, $departmentName, 'Labour', 'Visual');
                ?>
            ...
            <div class="step">
                <?php
                generateDropdown($conn, $departmentName, 'Operator', 'Framing');
                generateDropdown($conn, $departmentName, 'Labour', 'Framing');
                generateDropdown($conn, $departmentName, 'Operator', 'Junction Box');
                generateDropdown($conn, $departmentName, 'Labour', 'Junction Box');
                generateDropdown($conn, $departmentName, 'Operator', 'Potting');
                generateDropdown($conn, $departmentName, 'Labour', 'Potting');
                ?>
            ...
            <div class="step">
                <?php
                generateDropdown($conn, $departmentName, 'Operator', 'Curring');
                generateDropdown($conn, $departmentName, 'Labour', 'Curring');
                generateDropdown($conn, $departmentName, 'Operator', 'Cleaning');
                generateDropdown($conn, $departmentName, 'Labour', 'Cleaning');
                generateDropdown($conn, $departmentName, 'Operator', 'Hipot');
                generateDropdown($conn, $departmentName, 'Labour', 'Hipot');
                ?>
                <button type="button" class="btn btn-secondary" onclick="prevStep()">Previous</button>
                <button type="button" class="btn btn-primary" onclick="nextStep()">Next</button>
            </div>
            ...
            <div class="step">
                <?php
                generateDropdown($conn, $departmentName, 'Operator', 'Sunsimulator');
                generateDropdown($conn, $departmentName, 'Labour', 'Sunsimulator');
                generateDropdown($conn, $departmentName, 'Operator', 'EL');
                generateDropdown($conn, $departmentName, 'Labour', 'EL');
                generateDropdown($conn, $departmentName, 'Operator', 'Shorting');
                generateDropdown($conn, $departmentName, 'Labour', 'Shorting');
                ?>
