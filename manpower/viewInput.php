        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                if (isset($_GET['form_id']) && isset($_GET['departmentName'])) {
                    ...
                    $sql = "SELECT * FROM form_detailsinput WHERE form_id = ? AND departmentName = ?";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        // Units
                        $units = [
                            'manual_layup_and_bussing' => 'Manual Layup and Bussing',
                            'repairing_string' => 'Repairing String',
                            'repairing_module' => 'Repairing Module',
                            'eva_glass_loader' => 'EVA Glass Loader',
                            'stringer_layup1' => 'Stringer Layup 1',
                            'stringer_layup2' => 'Stringer Layup 2',
                            'stringer_layup3' => 'Stringer Layup 3',
                            'stringer_ms40' => 'Stringer MS40',
                            'bussing_tapping' => 'Bussing Tapping',
                            'eva_backsheet' => 'EVA Backsheet',
                            'el_repairing' => 'EL Repairing',
                            'lamination1' => 'Lamination 1',
                            'lamination2' => 'Lamination 2'
                        ];

                        // Work done fields
                        $work_done_fields = [
                            'manual_layup_and_bussing' => 'manualLayupBussWD',
                            'repairing_string' => 'repairingStringWD',
                            'repairing_module' => 'repairingModuleWD',
                            'eva_glass_loader' => 'evaGlassWD',
                            'stringer_layup1' => 'stringerL1WD',
                            'stringer_layup2' => 'stringerL2WD',
                            'stringer_layup3' => 'stringerL3WD',
                            'stringer_ms40' => 'stringerMS40WD',
                            'bussing_tapping' => 'bussTapingWD',
                            'eva_backsheet' => 'evaBacksheetWD',
                            'el_repairing' => 'elRepairWD',
                            'lamination1' => 'lamination1WD',
                            'lamination2' => 'lamination2WD'
                        ];
